    ...
    <div>
      ...
      >
        <div
          ...
          className={`absolute top-0 left-0 z-50 w-full h-full cursor-pointer transition-all duration-300 
        ...
        >
          <div className="absolute top-1/2 left-1/4 -translate-x-1/2 -translate-y-1/2 pointer-events-none text-center">
            ...
            />
            <p className="text-lg font-medium">El lujo también se pedalea.</p>
          </div>
        </div>
